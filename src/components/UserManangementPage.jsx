...
//   const [isSidebarOpen, setIsSidebarOpen] = useState(true); // Control sidebar open/close state
...
//       {inputsLocked && (
//         <Sidebar menuData={menuItems} isSidebarOpen={isSidebarOpen} toggleSidebar={toggleSidebar} />
//       )}
