...
// const Modal = ({ company, role, handleCompanyChange, handleRoleChange, handleOkClick }) => {
//   return (
//     <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
//       <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
//         <h2 className="text-2xl font-bold mb-4">Select Company and Role</h2>
//         <div className="mb-4">
//           <label className="block text-gray-700 text-sm font-bold mb-2">Select Company:</label>
//           <select
//             value={company}
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
        ...
        <div className="mb-4">
          <label className="inline-flex items-center">
            ...
            />
            <span className="ml-2 text-gray-700">Set as default for future use</span>
          </label>
        </div>
